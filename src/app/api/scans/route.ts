...
export async function POST(request: NextRequest) {
  try {
    ...
    if (
      (qrCode !== undefined && typeof qrCode !== 'string') ||
      (scannerName !== undefined && typeof scannerName !== 'string') ||
      (scannerEmail !== undefined && typeof scannerEmail !== 'string') ||
      (scannerPhone !== undefined && typeof scannerPhone !== 'string') ||
    ...
    if (location && (typeof location.latitude !== 'number' || typeof location.longitude !== 'number')) {
      return NextResponse.json(
        errorResponse('Invalid location format'),
        { status: 400 }
      );
    }
